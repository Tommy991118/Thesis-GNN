    ...
    def __create_model(self, proximity):
        ...
        with tf.name_scope("School"):
          for i in range(1, len(sizes3)):
            with tf.name_scope("enc{}".format(i)):
              W = tf.compat.v1.get_variable(name='W3{}'.format(i), shape=[sizes3[i - 1], sizes3[i]], dtype=tf.float32,
                                  initializer=w_init(), trainable = TRAINABLE)
              b = tf.compat.v1.get_variable(name='b3{}'.format(i), shape=[sizes3[i]], dtype=tf.float32, initializer=w_init(), trainable = TRAINABLE)
              ...
              tf.compat.v1.summary.histogram('Weight', W)
              tf.compat.v1.summary.histogram('bias', b)
              tf.compat.v1.summary.histogram('activations', encoded3)
        ...
        with tf.name_scope("House"):
          for i in range(1, len(sizes4)):
            with tf.name_scope("enc{}".format(i)):
              W = tf.compat.v1.get_variable(name='W4{}'.format(i), shape=[sizes4[i - 1], sizes4[i]], dtype=tf.float32,
                                  initializer=w_init(), trainable = TRAINABLE)
              b = tf.compat.v1.get_variable(name='b4{}'.format(i), shape=[sizes4[i]], dtype=tf.float32, initializer=w_init(), trainable = TRAINABLE)
              ...
              tf.compat.v1.summary.histogram('Weight', W)
              tf.compat.v1.summary.histogram('bias', b)
              tf.compat.v1.summary.histogram('activations', encoded4)
        ...
        if proximity == 'second-order':
            ...
            for i in range(1, len(sizes3)):
                W = tf.compat.v1.get_variable(name='W_ctx3{}'.format(i), shape=[sizes3[i - 1], sizes3[i]], dtype=tf.float32,
                                    initializer=w_init())
                b = tf.compat.v1.get_variable(name='b_ctx3{}'.format(i), shape=[sizes3[i]], dtype=tf.float32, initializer=w_init())
            ...
            for i in range(1, len(sizes4)):
                W = tf.compat.v1.get_variable(name='W_ctx4{}'.format(i), shape=[sizes4[i - 1], sizes4[i]], dtype=tf.float32,
                                    initializer=w_init())
                b = tf.compat.v1.get_variable(name='b_ctx4{}'.format(i), shape=[sizes4[i]], dtype=tf.float32, initializer=w_init())
