...
class GSNE:
  ...
  #Further the other arguments are: proximity, number of negative samples N,  batch size b, total iterations T.
    def __init__(self, args):
        ...
        #Get rows and dimensions of the 4 POIs, so we know how many attributes they have and how many observations.
        ...
        #The result will be an initial model with weights for all the attributes of the different POIs.
    ...
    def __create_model(self, proximity):
      #Performs xavier initialization for the weights.
        ...
        with tf.name_scope("Train"):
          ...
          #Creates the weights and biases based on the size, this is given to the shape of the new variable too.
          ...
          for i in range(1, len(sizes1)):
             with tf.name_scope("enc{}".format(i)):
              ...
              #X1 represents all the attributes of the POI which is then matrix multiplied to their weights added up to the bias.
              if i == 1:
